...
![ColorChecker A/B](results/ab_compare/ColorChecker.jpg)

**Indoor1**:

![Indoor1 A/B](results/ab_compare/Indoor1.jpg)
...
![CCM x CSE ablation](results/ccm_x_cse_ablation/ColorChecker.jpg)
